      ...
      sales: {
        ...
        sections: [
          ...
          },
          {
            heading: "คุณสมบัติ",
            items: [
              { text: "***เพศหญิง เท่านั้น***", className: "ref-item-emphasis" },
              "อายุ 18 ปีขึ้นไป",
              "วุฒิ ม.3",
      ...
      marketing: {
        ...
        sections: [
          ...
          },
          {
            ...
            items: [
              "รายได้เริ่มต้น 500-600++ บาท/วัน",
              "รายได้เริ่มต้น 12,000++ เมื่อผ่านทดลองงาน",
              "เวลางาน 8.00 - 17.00 น. (หยุดเสาร์เว้นเสาร์ และวันอาทิตย์)",
            ],
          },
          {
            heading: "สวัสดิการ",
            items: ["ประกันสังคม", "กองทุนสำรองเลี้ยงชีพ", "โบนัส"],
          },
          {
            heading: "คุณสมบัติ",
            items: [
              "เพศชาย/หญิง อายุ 20-30 ปี",
              "วุฒิ ปวช. ขึ้นไป / ปริญญาตรี ทุกสาขา",
              "มีทักษะการขาย",
              "สามารถใช้โปรแกรม Canva, Illustrator, Photoshop, CapCut ฯลฯ",
              "มีความคิดสร้างสรรค์ เชี่ยวชาญด้านสื่อโฆษณา",
              "หากมีผลงาน สามารถแนบมาในใบสมัครได้เลย",
            ],
          },
          {
            heading: "หน้าที่ความรับผิดชอบ",
            items: [
              "ขายสินค้าผ่านช่องทางออนไลน์",
              "ทำสื่อการตลาด รูปภาพ และถ่ายทำ-ตัดต่อวิดีโอสร้างคอนเทนต์",
              "ทำกิจกรรมการตลาดทั้งภายในและภายนอกสถานที่",
          ...
          },
          {
            ...
            items: [
              "บริษัท เอสซี กรุ๊ป (1989) จำกัด (สำนักงานใหญ่)",
              "เลขที่ 19 หมู่ 2 ซอยบางแก้ว ต.บางแก้ว",
